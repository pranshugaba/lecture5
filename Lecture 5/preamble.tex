...
\newcommand{\handout}[5]{
   ...
   \framebox{
      \vbox{
    \hbox to 5.78in { {\bf CSA E0 235: Cryptography}
     	 \hfill #2 }
       \vspace{4mm}
...
\newcommand{\lecture}[4]{\handout{#1}{#2}{Instructor: #3}{Scribe: #4}{Scribe for Lecture 5}}
...
\newenvironment{prooof}{\noindent{\bf Proof}\hspace*{1em}}{\hspace*{\fill}\rule{7pt}{7pt}\medskip}
